...
<#include "common/baseImport.ftl" />
    <meta charset="utf-8">
    <script type="text/javascript" src="${context.contextPath}/js/jquery.js"></script>
    ...
    <link href="${context.contextPath}/css/login/login.css" rel="stylesheet" rev="stylesheet" type="text/css" media="all"/>
</head>
    ...
    <div class="login-aside">
        ...
        <#if message?exists>
            ...
            <form class="form-horizontal loginForm" action="login" role="form" method="post">
                <div class="fm-item">
                    <input class="form-control username grey" name="username" id="fusername" type="text" value="alice@test.com">
                </div>
                <div class="fm-item">
                ...
                <div class="fm-item pos-r">
                    <input class="form-control yzm grey verifyCode" name="verifyCode" id="yzm" type="text" value="请输入你的验证码">
                    <div class="yz-img">
