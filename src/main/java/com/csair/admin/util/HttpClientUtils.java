...
public class HttpClientUtils {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        String url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx54e1edbbbe1cdec4&secret=397392d6e81ae250691507503affef97";
        HttpResultDto httpResultDto = sendHttpGetMsg(url);
